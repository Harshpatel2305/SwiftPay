...
$totalRecordsQuery = "SELECT COUNT(*) as total FROM dth_transactions WHERE operator_id={$_SESSION['id']}";
...
$query_pending = "SELECT * FROM dth_transactions WHERE operator_id={$_SESSION['id']} LIMIT $offset, $recordsPerPage";
                            ...
                            <ul class="pagination">
                                <?php for ($i = 1; $i <= $totalPages; $i++) { ?>
                                    <li class="page-item <?php echo ($i == $currentpage) ? 'active' : ''; ?>">
                                        <a class="page-link" href="index.php?view_products&page=<?php echo $i; ?>">
                                            <?php echo $i; ?>
                                        </a>
                                    </li>
                                <?php } ?>
