    ...
    if (isset($_GET['user_profile'])) {
        ...
        $get_admin = "select * from dth_operators where id='$edit_id'";
        ...
        $admin_pass = $row_admin['operator_password'];
    ...
    if (isset($_POST['update'])) {
        ...
        $update_admin = "update dth_operators set operator_email='$admin_name',operator_password='$admin_pass' where id='$admin_id'";
