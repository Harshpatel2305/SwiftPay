...
include 'db_connection.php';
    ...
    if (isset($_GET['operator_id'])) {
        ...
        $query_operator = "SELECT * FROM recharge_operators WHERE operator_id = '$operator_id'";
        ...
        if ($row = mysqli_fetch_assoc($result_operator)) {
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                $update_query = "UPDATE recharge_operators SET operator_name = '$new_operator_name' WHERE operator_id = '$operator_id'";
