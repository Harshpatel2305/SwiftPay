...
if (isset($_POST['approve'])) {
    ...
    $get_transaction_query = "SELECT * FROM dth_transactions WHERE id = '$transaction_id'";
    ...
    if ($transaction = mysqli_fetch_assoc($get_transaction_result)) {
        ...
        $update_transaction_query = "UPDATE dth_transactions SET approval_status = 'approved' WHERE id = '$transaction_id'";
    ...
    $update_transaction_query = "UPDATE dth_transactions SET approval_status = 'rejected' WHERE id = '$transaction_id'";
    mysqli_query($con, $update_transaction_query);
