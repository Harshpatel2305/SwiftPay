...
if (isset($_POST['delete_plan'])) {
    ...
    // Delete the plan
    $delete_query = "DELETE FROM recharge_plans WHERE id = '$plan_id'";
...
$totalRecordsQuery = "SELECT COUNT(*) as total FROM recharge_plans";
...
$query_plans = "SELECT recharge_plans.id, recharge_plans.operator_id, recharge_plans.plan_name, 
                recharge_plans.validity, recharge_plans.description, recharge_plans.price, 
                recharge_operators.operator_name
                FROM recharge_plans
                INNER JOIN recharge_operators ON recharge_plans.operator_id = recharge_operators.operator_id
                ...
                <?php while ($row_plan = mysqli_fetch_assoc($result_plans)) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- Action buttons for editing and deleting -->
                            <form method="get" action="edit_plans.php">
            ...
            <ul class="pagination">
                <?php for ($i = 1; $i <= $totalPages; $i++) { ?>
                    <li class="page-item <?php echo ($i == $currentpage) ? 'active' : ''; ?>">
                        <a class="page-link" href="test_3.php?page=<?php echo $i; ?>">
                            <?php echo $i; ?>
                        </a>
                    </li>
                <?php } ?>
