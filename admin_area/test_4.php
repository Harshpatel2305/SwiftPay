...
if (isset($_POST['delete_plan'])) {
    ...
    // Delete the plan
    $delete_query = "DELETE FROM bsnl_plans WHERE plan_id = '$plan_id'";
...
$totalRecordsQuery = "SELECT COUNT(*) as total FROM bsnl_plans";
...
$query_plans = "SELECT plan_id,data,validity,description,price from bsnl_plans
