...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['plan_id']) && isset($_POST['data']) && isset($_POST['validity']) && isset($_POST['description']) && isset($_POST['price'])) {
        ...
        // Update the plan
        $update_query = "UPDATE jio_plans SET data = '$data', validity = '$validity', description = '$description', price = '$price' WHERE plan_id = '$plan_id'";
...
if (isset($_GET['plan_id'])) {
    ...
    $query_plan = "SELECT * FROM jio_plans WHERE plan_id = '$plan_id'";
