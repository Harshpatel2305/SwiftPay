...
$totalRecordsQuery = "SELECT COUNT(*) as total FROM dth_transactions";
...
$query_pending = "SELECT * FROM dth_transactions LIMIT $offset, $recordsPerPage";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($row['approval_status'] === 'PENDING') { ?>
                                                <form method="post" action="approve_dth_transaction.php">
